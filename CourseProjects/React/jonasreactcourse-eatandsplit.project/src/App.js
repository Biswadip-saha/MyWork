	...
	return (
		<div className="app">
			<div className="sidebar">
				...
				<Button onClickFunction={handleShowAddFriend}>{showAddFriend ? "Close" : "Add Friend"}</Button>
			</div>
...
function Friend({ friend, onSelection, selectedFriend }) {
	...
	return (
		<li className={isSelected ? "selected" : ""}>
			...
			<Button onClickFunction={() => onSelection(friend)}>{isSelected ? "Close" : "Select"}</Button>
		</li>
	);
}
